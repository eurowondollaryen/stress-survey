...
/* 설문결과의 계산결과를 저장하는 테이블 */
DROP TABLE ICTSURVEYRESULT;
CREATE TABLE ICTSURVEYRESULT (
    USER_ID VARCHAR(200), /* 설문 대상자 ID */
    SRVY_ID VARCHAR(10), /* 설문ID */
    START_TIME VARCHAR(14), /* 설문 기간 - 시작 */
    END_TIME VARCHAR(14), /* 설문 기간 - 끝 */
...
CREATE TABLE ICTSURVEYQUESTIONDIV (
    SRVY_ID VARCHAR(10) /* 설문ID */
    , QSTN_DIV INTEGER /* 질의구분 */
    , DTL_NOTE VARCHAR(255)
    , START_QSTN_SEQ INTEGER
    , END_QSTN_SEQ INTEGER
    , RANGE_MALE_PASS_START FLOAT
    , RANGE_MALE_PASS_END FLOAT
    , RANGE_MALE_WARN_START FLOAT
    , RANGE_MALE_WARN_END FLOAT
    , RANGE_FEMALE_PASS_START FLOAT
    , RANGE_FEMALE_PASS_END FLOAT
    , RANGE_FEMALE_WARN_START FLOAT
    , RANGE_FEMALE_WARN_END FLOAT
    , PRIMARY KEY (SRVY_ID, QSTN_DIV)
);
