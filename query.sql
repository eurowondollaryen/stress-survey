...
CREATE TABLE ICTSURVEYQUESTIONDIV (
    ...
    , RANGE_PASS_START FLOAT
    , RANGE_PASS_END FLOAT
    , RANGE_WARN_START FLOAT
    , RANGE_WARN_END FLOAT
    , PRIMARY KEY (SRVY_ID, QSTN_DIV, USER_SEX)
);
...
/* 결과값 계산 FUNCTION */
CREATE OR REPLACE FUNCTION SF_CALCULATE_RESULT(iUSER_SEX VARCHAR, iSRVY_ID VARCHAR, iQSTN_DIV)
RETURNS VARCHAR
LANGUAGE PLPGSQL
AS
$$
